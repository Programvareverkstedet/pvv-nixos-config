...
in
{
  options.services.fluent-bit.extraStructuredMetadataKeys = lib.mkOption {
    type = lib.types.attrsOf lib.types.bool;
    default = { };
    description = ''
      Extra structured metadata keys to include in the default output.
    '';
  };
        ...
        pipeline = {
          ...
          outputs = [{
            ...
            structured_metadata_map_keys = lib.concatMapStringsSep "," (k: "$" + k) ([
              ...
              "uid"
              "unit"
            ] ++ lib.attrNames (lib.filterAttrs (_: enabled: enabled) cfg.extraStructuredMetadataKeys));
